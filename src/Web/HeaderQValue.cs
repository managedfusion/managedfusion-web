...
namespace ManagedFusion.Web
{
	...
	public struct HeaderQValue : IComparable<HeaderQValue>
	{
		...
		public HeaderQValue(string value)
			: this(value, 0)
		{ }
		...
		public HeaderQValue(string value, int ordinal)
		{
			_name = null;
			_weight = 0;
			_ordinal = ordinal;
		...
		public static HeaderQValue Parse(string value)
		{
			HeaderQValue item = new HeaderQValue();
		...
		/// <returns></returns>
		public static HeaderQValue Parse(string value, int ordinal)
		{
			HeaderQValue item = Parse(value);
		...
		/// </summary>
		/// <param name="value">The string to parse</param>
		static void ParseInternal(ref HeaderQValue target, string value)
		{
		...
		/// <returns></returns>
		public int CompareTo(HeaderQValue other)
		{
		...
		/// <returns></returns>
		public static int CompareByWeightAsc(HeaderQValue x, HeaderQValue y)
		{
		...
		/// <param name="y">The second QValue</param>
		/// <returns></returns>
		public static int CompareByWeightDesc(HeaderQValue x, HeaderQValue y)
		{
			return -x.CompareTo(y);
		}
