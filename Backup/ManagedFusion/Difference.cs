...
namespace ManagedFusion
{
	...
	public class Difference
	{
		...
		public DifferenceItem[] DiffText(string TextA, string TextB)
		{
		...
		/// <returns>Returns a array of Items that describe the differences.</returns>
		public static DifferenceItem[] DiffText(string TextA, string TextB, bool trimSpace, bool ignoreSpace, bool ignoreCase)
		{
		...
		/// <returns>Returns a array of Items that describe the differences.</returns>
		public static DifferenceItem[] DiffInt(int[] ArrayA, int[] ArrayB)
		{
			// The A-Version of the data (original data) to be compared.
		...
		/// </summary>
		/// dynamic array
		private static DifferenceItem[] CreateDiffs(DiffData DataA, DiffData DataB)
		{
			ArrayList a = new ArrayList();
			DifferenceItem aItem;
			DifferenceItem[] result;
			...
			result = new DifferenceItem[a.Count];
			a.CopyTo(result);
